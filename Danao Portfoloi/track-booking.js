document.addEventListener('DOMContentLoaded', () => {
    ...
    <i class="fas ${
        booking.deviceType === 'desktop'
            ? 'fa-desktop'
            : booking.deviceType === 'laptop'
                ? 'fa-laptop'
                : 'fa-question'
    }"></i>
    ...
    <div class="booking-detail">
        ...
        <span>${booking.date === 'TBD' ? 'Date pending' : booking.date} at ${booking.time}</span>
    </div>
    ...
    window.viewBookingDetails = function (id) {
        ...
        document.getElementById('modalContent').innerHTML = `
            <div>
                ...
                <p><strong>Device Type:</strong> ${booking.deviceType || 'Not specified'}</p>
